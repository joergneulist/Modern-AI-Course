...
\begin{itemize}
    ...
    \items Since $Q$, $K$, and $V$ are dependent on $X$, it is not obvious that this operation prevents all leakage. I'm annotating the proof here, but it can be found in the video.
\end{itemize}
